...
@Injectable()
export class SpeciesProtocolsService extends GenericTableService{
    ...
    constructor(public http: HttpClient,
        ...
        this.sqLiteTypes.set('dataset_id', 'text');

    }

    serviceName = 'species_protocols';
    tableName = 'species_protocols';
        ...
        for(var speciesProtocol of speciesProtocols) {
            ...
            for(var protocolPhenophase of protocolPhenophases) {
                if (speciesProtocol.protocol_id === protocolPhenophase.protocol_id) {
                    speciesProtocol.protocolPhenophases.push(Object.assign({}, protocolPhenophase));
                }
            }
        }
