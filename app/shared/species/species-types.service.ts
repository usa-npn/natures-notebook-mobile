...
@Injectable()
export class SpeciesTypesService extends GenericTableService{
    ...
    constructor(public http: HttpClient,
        ...
        this.sqLiteTypes.set('species_type', 'text');
        this.sqLiteTypes.set('comment', 'text');
        this.sqLiteTypes.set('user_display', 'text');
        this.sqLiteTypes.set('kingdom', 'text');
        this.sqLiteTypes.set('image_path', 'text');
    }

    serviceName = 'species_types';
    tableName = 'species_types';
    primaryKey = 'species_type_id';
